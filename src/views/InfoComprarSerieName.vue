<template>
    ...
    <div class="fff1">
     ...
     <div class="divcomprar">
            <div>
            <!-- <h4 class="inlineInfo1">comprar:</h4> -->
    ...
    <div class="divMostrarDescricao1">
        <div>
...
export default {
    ...
    mounted(){
        axios({
            method: "get",
            url: "http://localhost:4000/infoSerieComprarNome?nome=" + this.$route.query.nome,
