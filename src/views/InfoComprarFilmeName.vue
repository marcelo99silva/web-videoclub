<template>
    ...
    <div class="fff1">
        ...
        <div class="divMostarInfo1">
            <div>
            <h4 class="inlineInfo1">Duração:</h4>
    ...
    <div class="divcomprar">
            <div>
            <button class="butaoComprar"  @click="comprar()">&#160;Comprar&nbsp;</button>
...
export default {
    ...
    mounted(){
        axios({
            method: "get",
            url: "http://localhost:4000/infoFilmeComprarNome?nome=" + this.$route.query.nome,
        })
        .then((response) =>{
            this.id = response.data[0].idFilmeSerie,
